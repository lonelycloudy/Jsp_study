...
public class DefaultActionInvocation implements ActionInvocation {
    ...
    public String invoke() throws Exception {
    	System.out.println(Thread.currentThread() + "DefaultActionInvocation.invoke");
        ...
        try {
            ...
            if (interceptors.hasNext()) {
                ...
                System.out.println("interceptor:" + interceptor.getName());
    ...
    public String invokeActionOnly() throws Exception {
    	System.out.println(Thread.currentThread() + "DefaultActionInvocation.invokeActionOnly");
    ...
    protected String invokeAction(Object action, ActionConfig actionConfig) throws Exception {
        ...
        try {
            ...
            if (!methodCalled) {
            	System.out.println("执行action方法:" + action.hashCode());
